---
campos: ['Titular','Electricidad']
funciones: ['correo','rebt']
title: Distancia mínima entre filas de módulos
author: by Watt Bucket 
header-includes: |
    \usepackage{fancyhdr}
    \pagestyle{fancy}
    \fancyhead[C]{}
    \fancyhead[R]{Distancia mínima entre filas de módulos}
    \fancyfoot[C]{Distancia mínima entre filas de módulos}
    \fancyfoot[R]{\thepage}
...
# Distancia mínima entre filas de módulos. <a href="../111_Calculos_Distancia mínima entre filas de módulos.pdf">   :fontawesome-solid-file-pdf:</a>,<a href="../111_Calculos_Distancia mínima entre filas de módulos formulario">    :fontawesome-solid-file-pen:</a>
...
|    |   $\alpha [^o]$ |   d[m] |   c[m] |   h[m] |   $E_a [kWh]$ |
|---:|----------------:|-------:|-------:|-------:|--------------:|
|  0 |              90 |   2.66 |   0    |   1    |        542.75 |
|  1 |               0 |   0    |   1    |   0    |        685.54 |
|  2 |              15 |   0.69 |   0.97 |   0.26 |        769.99 |
|  3 |              30 |   1.33 |   0.87 |   0.5  |        811.6  |
