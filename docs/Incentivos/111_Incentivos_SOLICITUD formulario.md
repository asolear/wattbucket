# SOLICITUD <a href="../111_Incentivos_SOLICITUD.pdf">   :fontawesome-solid-file-pdf:</a>,<a href="../111_Incentivos_SOLICITUD">    :fontawesome-solid-file:</a>
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=QR SOLICITUD" method="post" enctype="text/plain">
        <input type="hidden" name="correo_Documento" id="correo_Documento"  value="SOLICITUD"><br>
