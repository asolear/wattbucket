# Autoconsumo Nave Industrial <a href="../000_Proyectos_Autoconsumo Nave Industrial.pdf">   :fontawesome-solid-file-pdf:</a>,<a href="../000_Proyectos_Autoconsumo Nave Industrial">    :fontawesome-solid-file:</a>
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=QR Autoconsumo Nave Industrial" method="post" enctype="text/plain">
