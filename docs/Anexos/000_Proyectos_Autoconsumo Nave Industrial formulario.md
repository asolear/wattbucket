...
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=WB Autoconsumo Nave Industrial" method="post" enctype="text/plain">
        <input type="hidden" name="correo_Documento" id="correo_Documento"  value="Autoconsumo Nave Industrial"><br>
