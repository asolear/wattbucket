# planos2fig <a href="../000_desarrollo_planos2fig.pdf">   :fontawesome-solid-file-pdf:</a>,<a href="../000_desarrollo_planos2fig">    :fontawesome-solid-file:</a>
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=QR planos2fig" method="post" enctype="text/plain">
