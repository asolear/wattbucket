# Diseño del sistema eléctrico <a href="../000_Estudios_Diseño del sistema eléctrico.pdf">   :fontawesome-solid-file-pdf:</a>,<a href="../000_Estudios_Diseño del sistema eléctrico">    :fontawesome-solid-file:</a>
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=QR Diseño del sistema eléctrico" method="post" enctype="text/plain">
