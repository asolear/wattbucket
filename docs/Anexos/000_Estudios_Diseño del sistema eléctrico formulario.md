...
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=WB Diseño del sistema eléctrico" method="post" enctype="text/plain">
        <input type="hidden" name="correo_Documento" id="correo_Documento"  value="Diseño del sistema eléctrico"><br>
