...
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=WB Estudio económico" method="post" enctype="text/plain">
        <input type="hidden" name="correo_Documento" id="correo_Documento"  value="Estudio económico"><br>
