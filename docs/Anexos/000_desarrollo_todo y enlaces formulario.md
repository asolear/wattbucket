# todo y enlaces <a href="../000_desarrollo_todo y enlaces.pdf">   :fontawesome-solid-file-pdf:</a>,<a href="../000_desarrollo_todo y enlaces">    :fontawesome-solid-file:</a>
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=QR todo y enlaces" method="post" enctype="text/plain">
        <input type="hidden" name="correo_Documento" id="correo_Documento"  value="todo y enlaces"><br>
