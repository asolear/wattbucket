...
campos: ['Tecnico']
title: 
    INFORME JUSTIFICATIVO de la previsión de que el consumo anual de energía por parte
    del consumidor o consumidores asociados a la instalación sea igual o mayor al 80 % de
    la energía anual generada por la instalación objeto de la ayuda.
abstract: 
    ...
    fase de justificación1, ambos documentos firmados por técnico competente o empresa instaladora,
    en los que se estime y justifique respectivamente que el consumo de la instalación es igual o superior
...
header-includes: |
    ...
    \pagestyle{fancy}
    \fancyhead{}
    \fancyhead[R]{Justificante CONSUMO ANUAL DE ENERGÍA IGUAL O SUPERIOR AL 80 PC DE LA ENERGÍA GENERADA}
    \fancyfoot{}
...
| ---- | ------------------------------------------------------------ | ------ |
| a    | Ubicación [^10]                                              | 33     |
| b    | Consumidores y CUPS asociados al autoconsumo [^11]           |        |
| c    | Energía consumida anual estimada de los consumidores asociados a la instalación de generación de autoconsumo (kWh) [^12] | 8888 |
| d    | Energía generada anual estimada de la nueva instalación (kWh)[^13] | 33   |
...
| ------------------------------------------------------------ | ---------------- | ----------- |
| Vivienda                                                     | kWh/kWcontratado | 872[^4]   |
| Vehículo eléctrico a futuro                                  | kWh/ud           | 1630[^5]  |
| Electrificación de demanda de calor a futuro con bomba de calor | kWh/vivienda     | 4000[^6] |
| Incorporación de equipos de aire acondicionado con bomba de calor | kWh/ud           | 180[^7]   |
...
[^1]:[JUSTIFICACIÓN DEL CONSUMO ANUAL DE ENERGÍA IGUAL O SUPERIOR AL 80% DE LA ENERGÍA GENERADA POR LA INSTALACIÓN](https://www.idae.es/sites/default/files/documentos/ayudas_y_financiacion/RD477-2021_Autoconsumo_y_almacenamiento/2022_02_08-Informe_80%25_Consumo_RD477.pdf)
[^2]: En el caso de autoconsumos colectivos se presentará la suma de consumos de todos los suministros asociados al mismo,
separados por CUPS.
[^3]: Para otros consumos no considerados en la tabla será igualmente razonable la consideración de ratios de fuentes como
[^4]:Considerando un consumo medio anual de electricidad por vivienda de 3.487 kWh y una potencia media contratada de 4
...
[^5]:  Considerando un consumo medio de 16,3 kWh/km y 10.000 km al año.
[^6]: Considerando 12.000 kWh de demanda de calor al año y rendimiento medio estacional (SPF) de 3,0 para la bomba de
calor.

[^7]: Considerando 2 horas de funcionamiento medio diario a una potencia media de 1 kW durante 90 días al año.
[^10]: Dirección (calle/municipio/CP/provincia ó polígono/parcela/municipio/provincia), y referencia catastral o coordenadas
UTM.
[^11]: Incluido consumidores y CUPS correspondiente de cada uno de los consumidores asociados al autoconsumo en el cuadro  'Consumidores asociados'.
[^12]: De acuerdo con los cálculos justificativos del apartado 3.1.
[^13]: De acuerdo con los cálculos justificativos del apartado 3.2.
[^14]:  [Nota informativa nº 1: Documentación imprescindible para justificar(Incentivos <50.000€ de ciudadanos o de empresas privadas)](https://www.agenciaandaluzadelaenergia.es/sites/default/files/Documentos/Incentivos/autoconsumo_nota_1_documentacion_imprescindible_para_justificar.pdf)

[^15]: [USTIFICACIÓN FOTOGRÁFICA DE EJECUCIÓN](https://incentivos.agenciaandaluzadelaenergia.es/documentacion/Autoconsumo2021/autoconsumo_justificacion_documento_fotografico.pdf)
...
![](assets/_qr_111_Incentivos_JustificanteCONSUMOANUALDEENERGÍAIGUALOSUPERIORAL80PCDELAENERGÍAGENERADA.png){width=25% height=auto}

[https://wattbucket.com/Anexos/111_Incentivos_Justificante CONSUMO ANUAL DE ENERGÍA IGUAL O SUPERIOR AL 80 PC DE LA ENERGÍA GENERADA/](https://wattbucket.com/Anexos/111_Incentivos_Justificante CONSUMO ANUAL DE ENERGÍA IGUAL O SUPERIOR AL 80 PC DE LA ENERGÍA GENERADA/)
