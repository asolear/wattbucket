# DECLARACIÓN RESPONSABLE del consumo <a href="../111_Incentivos_DECLARACIÓN RESPONSABLE del consumo.pdf">   :fontawesome-solid-file-pdf:</a>,<a href="../111_Incentivos_DECLARACIÓN RESPONSABLE del consumo">    :fontawesome-solid-file:</a>
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=QR DECLARACIÓN RESPONSABLE del consumo" method="post" enctype="text/plain">
