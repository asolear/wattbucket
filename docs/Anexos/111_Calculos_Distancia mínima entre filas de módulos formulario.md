# Distancia mínima entre filas de módulos <a href="../111_Calculos_Distancia mínima entre filas de módulos.pdf">   :fontawesome-solid-file-pdf:</a>,<a href="../111_Calculos_Distancia mínima entre filas de módulos">    :fontawesome-solid-file:</a>
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=QR Distancia mínima entre filas de módulos" method="post" enctype="text/plain">
