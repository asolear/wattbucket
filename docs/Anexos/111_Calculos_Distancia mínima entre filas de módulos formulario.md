...
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=WB Distancia mínima entre filas de módulos" method="post" enctype="text/plain">
        <input type="hidden" name="correo_Documento" id="correo_Documento"  value="Distancia mínima entre filas de módulos"><br>
