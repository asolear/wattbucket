# Autoconsumo Residencial en Bloque de Pisos
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=WB Autoconsumo Residencial en Bloque de Pisos" method="post" enctype="text/plain">
        <input type="hidden" name="correo_Documento" id="correo_Documento"  value="Autoconsumo Residencial en Bloque de Pisos"><br>
 ...
 <h3>Titular</h3> <label>Nombre</label><br> <input type="text" id="Titular_Nombre" name="Titular_Nombre" > <br><br> <label>CIF</label><br> <input type="text" id="Titular_CIF" name="Titular_CIF" > <br><br> <label>Direccion</label><br> <input type="text" id="Titular_Direccion" name="Titular_Direccion" > <br><br> <label>Poblacion</label><br> <input type="text" id="Titular_Poblacion" name="Titular_Poblacion" > <br><br> <label>Provincia</label><br> <input type="text" id="Titular_Provincia" name="Titular_Provincia" > <br><br> <label>CP</label><br> <input type="text" id="Titular_CP" name="Titular_CP" > <br><br> <label>Telefono</label><br> <input type="text" id="Titular_Telefono" name="Titular_Telefono" > <br><br> <h3>Electricidad</h3> 
