# Autoconsumo Residencial en Bloque de Pisos <a href="../000_Proyectos_Autoconsumo Residencial en Bloque de Pisos.pdf">   :fontawesome-solid-file-pdf:</a>,<a href="../000_Proyectos_Autoconsumo Residencial en Bloque de Pisos">    :fontawesome-solid-file:</a>
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=QR Autoconsumo Residencial en Bloque de Pisos" method="post" enctype="text/plain">
