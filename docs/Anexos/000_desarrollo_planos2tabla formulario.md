# planos2tabla <a href="../000_desarrollo_planos2tabla.pdf">   :fontawesome-solid-file-pdf:</a>,<a href="../000_desarrollo_planos2tabla">    :fontawesome-solid-file:</a>
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=QR planos2tabla" method="post" enctype="text/plain">
