...
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=WB Dimensionado del sistema" method="post" enctype="text/plain">
        <input type="hidden" name="correo_Documento" id="correo_Documento"  value="Dimensionado del sistema"><br>
