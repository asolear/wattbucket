# Dimensionado del sistema <a href="../000_Estudios_Dimensionado del sistema.pdf">   :fontawesome-solid-file-pdf:</a>,<a href="../000_Estudios_Dimensionado del sistema">    :fontawesome-solid-file:</a>
<body>
    ...
    <form action="mailto:info@wattbucket.com?subject=QR Dimensionado del sistema" method="post" enctype="text/plain">
